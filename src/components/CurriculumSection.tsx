...
const curriculumData = {
  1: {
    ...
    courses: [
      ...
      { name: "العقيدة (1)", books: [{ title: "مختصر لوامع الأنوار البهية", authors: ["حسن بن عمر معروف الشطي الدمشقي"] }] },
      { name: "السيرة النبوية (1)", books: [{ title: "الرحيق المختوم", authors: ["المباركفوري"] }] },
      ...
      { name: "أصول الفقه (1)", books: [{ title: "نشر البنود على مراقي السعود", authors: ["سيدي عبد الله بن إبراهيم العلوي"] }] },
      { name: "النحو (1)", books: [{ title: "شرح ابن عقيل على ألفية ابن مالك", authors: ["ابن عقيل"] }] },
      { name: "البلاغة (1)", books: [{ title: "حلية اللب المصون على الجوهر المكنون", authors: ["الشيخ أحمد الدمنهوري"] }] },
      { name: "المنطق", books: [{ title: "إيضاح المبهم لمعاني السلم", authors: ["الشيخ أحمد الدمنهوري"] }] }
    ]
  },
  2: {
    ...
    courses: [
      ...
      { name: "العقيدة (2)", books: [{ title: "مختصر لوامع الأنوار البهية", authors: ["حسن بن عمر معروف الشطي الدمشقي"] }] },
      { name: "السيرة النبوية (2)", books: [{ title: "الرحيق المختوم", authors: ["المباركفوري"] }] },
      ...
      { name: "أصول الفقه (2)", books: [{ title: "نشر البنود على مراقي السعود", authors: ["سيدي عبد الله بن إبراهيم العلوي"] }] },
      { name: "النحو (2)", books: [{ title: "شرح ابن عقيل على ألفية ابن مالك", authors: ["ابن عقيل"] }] },
      { name: "البلاغة (2)", books: [{ title: "حلية اللب المصون على الجوهر المكنون", authors: ["أحمد الدمنهوري"] }] },
      {
        name: "الصرف",
        books: [
          { title: "إتحاف الطرف في علم الصرف", authors: ["ياسين الحافظ"] },
          { title: "شرح بدر الدين على لامية الأفعال", authors: ["محمد بن محمد بن مالك"] }
        ]
      }
    ]
  },
  3: {
    ...
    courses: [
      ...
      { name: "تفسير القرآن (2)", books: [{ title: "أنوار التنزيل وأسرار التأويل", authors: ["عبد الله الشيرازي البيضاوي"] }] },
      ...
      { name: "أصول الفقه (3)", books: [{ title: "نشر البنود على مراقي السعود", authors: ["سيدي عبدالله بن الحاج العلوي"] }] },
      { name: "آداب البحث والمناظرة", books: [{ title: "رسالة الآداب في علم آداب البحث والمناظرة", authors: ["محمد محي الدين عبدالحميد"] }] },
      {
      ...
      { name: "النحو (3)", books: [{ title: "شرح ابن عقيل على ألفية ابن مالك", authors: ["ابن عقيل"] }] },
      { name: "النصوص الأدبية (1)", books: [{ title: "(النصوص المختارة) لطلبة الجامعات والمعاهد العلمية", authors: ["جواهر الأدب"] }] }
    ]
  },
  4: {
    ...
    courses: [
      ...
      { name: "الفقه المقارن (أ)", books: [{ title: "مقارنة المذاهب في الفقه", authors: ["محمود شلتوت", "محمد سايس"] }] },
      {
      ...
      { name: "أصول الفقه (4)", books: [{ title: "نشر البنود على مراقي السعود", authors: ["سيدي عبدالله بن الحاج العلوي"] }] },
      { name: "النحو والصرف", books: [{ title: "شرح ابن عقيل على ألفية ابن مالك", authors: ["ابن عقيل"] }] },
      { name: "النصوص الأدبية (2)", books: [{ title: "(النصوص المختارة) لطلبة الجامعات والمعاهد العلمية", authors: ["جواهر الأدب"] }] },
      {
        name: "مناهج البحث",
        books: [
          { title: "ورقات في البحث والكتابة", authors: ["د. عبدالحميد عبدالله الهرامة"] },
          { title: "صناعة البحوث العلمية وتحقيق النصوص العربية", authors: ["د. محمد خليل الزروق"] }
        ]
      }
    ]
  },
  5: {
    ...
    courses: [
      ...
      { name: "مناهج المحدثين والعلل", books: [{ title: "مناهج المحدثين وعلم العلل", authors: ["اختيارات المجلس العلمي"] }] },
      ...
      { name: "الفقه المقارن (ب)", books: [{ title: "مقارنة المذاهب في الفقه", authors: ["محمود شلتوت", "محمد سايس"] }] },
      { name: "قضايا فقهية معاصرة", books: [{ title: "قضايا فقهية معاصرة", authors: ["الصادق بن عبدالرحمن الغرياني"] }] },
      { name: "مقاصد الشريعة", books: [{ title: "شفاء الغليل في بيان الشبه والمخيل ومسالك التعليل", authors: ["الغزالي"] }] },
      { name: "السياسة الشرعية", books: [{ title: "منهج السياسة الشرعية", authors: ["اختيارات المجلس العلمي"] }] },
      {
        name: "التربية وأصول الإفتاء",
        books: [
          { title: "أصول الإفتاء وآدابه", authors: ["محمد تقي الدين العثماني"] },
          { title: "نظم المعتمد من الأقوال والكتب في المذهب المالكي", authors: ["محمد النابغة الغلاوي الشنقيطي"] }
        ]
      },
      { name: "أصول الفقه (5)", books: [{ title: "نشر البنود على مراقي السعود", authors: ["سيدي عبدالله بن الحاج العلوي"] }] },
      { name: "الفرق والمذاهب المعاصرة", books: [{ title: "الأديان والفرق والمذاهب المعاصرة", authors: ["عبدالقادر شيبة الحمد"] }] },
      { name: "الاقتصاد الإسلامي", books: [{ title: "الاقتصاد الإسلامي أسس مبادئ وأهداف", authors: ["عبد الله الطريقي"] }] },
      { name: "النصوص الأدبية (3)", books: [{ title: "(النصوص المختارة) لطلبة الجامعات والمعاهد العلمية", authors: ["جواهر الأدب"] }] },

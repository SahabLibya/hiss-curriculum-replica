  ...
  const news = [
    {
      ...
      excerpt: "تعلن كلية الإفتاء والعلوم الشرعية عن بدء قبول طلبات التسجيل للعام الدراسي الجديد في جميع التخصصات المتاحة",
      date: "15 شعبان 1445",
      image: "📢",
      category: "إعلانات"
    },
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            آخر الأخبار والفعاليات والإصدارات من كلية الإفتاء والعلوم الشرعية
          </p>
        </div>
